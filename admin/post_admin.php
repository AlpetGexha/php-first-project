 ...
 <body>
     ...
     <div class="container mt-5">
         ...
         <?php
            ...
            $result = mysqli_query($db, "SELECT u.emri, u.mbiemri, p.emri_post, u.username, p.body, p.image, p.post_time,  p.id from post p, users u where p.user_id = u.id  order by p.id DESC  LIMIT $offset, $total_records_per_page");
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "
>>>>>>> cd47f62df0270ba41f4d11df6167fa6bf0251e3c
        <td>
